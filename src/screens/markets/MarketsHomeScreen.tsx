...
import { CryptoRowSkeleton, CryptoRowSkeletonList } from "@/components/markets/CryptoRowSkeleton";
import { AppTopBar } from "@/components/layout/AppTopBar";
import { ErrorCallout } from "@/components/ui/ErrorCallout";
import { MAX_STREAMER_SYMBOLS } from "@/config/streamer";
...
import type { MainTabParamList, MarketsStackParamList } from "@/navigation/types";
...
import type { FiltersState, MarketPreset } from "@/store/slices/filtersSlice";
import { selectFilteredMarketAssets } from "@/store/selectors/marketSelectors";
import type { RootState } from "@/store";
import { cardShadow, colors, radii, spacing, toolbarPanelShadow, typography } from "@/theme";
...
export function MarketsHomeScreen() {
  ...
  const streamSymbols = useMemo(() => {
    ...
    for (const a of filtered) {
      ...
      seen.add(u);
      out.push(u);
      if (out.length >= MAX_STREAMER_SYMBOLS) break;
    }
    return out;
  }, [filtered]);

  useCryptocomparePriceStream(streamSymbols, isFocused);
      ...
      <SafeAreaView style={styles.safe} edges={["top"]}>
        ...
        <View style={styles.centered}>
          <ErrorCallout
            ...
            message="Reintentá en unos segundos. Si el problema sigue, comprobá tu conexión y la API key."
