...
import { CryptoRow, flattenTopCoinsPages, useTopCoinsInfiniteQuery } from "@/features/markets";
import {
...
export function FavoritesScreen() {
  ...
  const query = useFavoriteAssetsQuery(entries);
  ...
  useBinancePriceStream(streamSymbols, isFocused && ready && fsyms.length > 0);
